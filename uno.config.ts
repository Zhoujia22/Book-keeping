...
export default defineConfig({
  ...
  shortcuts: {
    'j-btn': 'text-18px h-48px w-100% bg-#ffd103 b-none text-black rounded-8px',
    'j-input-text': 'h-48px px-16px leading-32px  py-8px b-1 b-b-solid focus:shadow focus:shadow-inset rounded-8px text-18px ',
