  ...
  return (
        <div>
            ...
            <form onSubmit={onSubmit} px-16px py-32px flex flex-col gap-y-8px >
                ...
                <Input type='emoji' label={<span>图标<span text-24px>{data.sign}</span></span>} value={data.sign} onChange={sign => setData({ sign })}
                    error={error.sign?.[0]} />
