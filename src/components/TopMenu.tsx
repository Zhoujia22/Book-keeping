...
export const TopMenu: React.FC<Props> = (props) => {
  ...
  return (
    <>
      <div fixed left-0 top-0 w='100%' h='100%' className='bg-black:75' z='[calc(var(--z-menu)-1)]' onClick={onClickMask} />
      <div fixed top-0 left-0 w='70vw' max-w-20em h-screen flex flex-col b-3px b-red bg-white z='[var(--z-menu)]'>
